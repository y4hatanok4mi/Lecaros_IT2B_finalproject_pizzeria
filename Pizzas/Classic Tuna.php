    ...
    <body>		
		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="../themes/images/Pizza Photos/Classic Tuna/Main.jpg" class="thumbnail" data-fancybox-group="group1" ><img alt="" src="../themes/images/Pizza Photos/Classic Tuna/Main.jpg"></a>												
								<ul class="thumbnails small">								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Classic Tuna/1.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Classic Tuna/1.jpg" alt=""></a>
									</li>								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Classic Tuna/2.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Classic Tuna/2.jpg" alt=""></a>
									</li>													
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Classic Tuna/3.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Classic Tuna/3.jpg" alt=""></a>
									</li>
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Classic Tuna/4.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Classic Tuna/4.jpg" alt=""></a>
									</li>
								</ul>
							</div>
							<div class="span5">									
						...
						<div class="row">
							<div class="span9">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="home">Classic Tuna is a simple Italian pizza that uses tuna as a topping. It consists of a basic pizza dough that is topped with tomato sauce, mozzarella, and olive oil-packed tuna. This classic pizza can be found in most Italian pizzerias since canned tuna is a convenient ingredient that can be used year-round.</div>
			...
			<section id="footer-bar">
				...
				<br/>Always Great never Greasy!</p></p>
						<br/>
