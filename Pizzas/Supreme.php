			...
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="../themes/images/Pizza Photos/Supreme/Main.jpg" class="thumbnail" data-fancybox-group="group1" ><img alt="" src="../themes/images/Pizza Photos/Supreme/Main.jpg"></a>												
								<ul class="thumbnails small">								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Supreme/1.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Supreme/1.jpg" alt=""></a>
									</li>								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Supreme/2.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Supreme/2.jpg" alt=""></a>
									</li>													
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Supreme/3.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Supreme/3.jpg" alt=""></a>
									</li>
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Supreme/4.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Supreme/4.jpg" alt=""></a>
									</li>
								</ul>
							</div>
							<div class="span5">									
								<h4><strong>Price: ₱399.00</strong></h4>
							</div>
							<div class="span5">
						...
						<div class="row">
							<div class="span9">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="home">Regardless of your favorite flavors, the supreme pizza has something for everybody. It truly caters to meat lovers, veggie lovers, and those of us who like a little bit of both. So give your local pizzeria a call and order a supreme pizza and let us know what comes on it.</div>
									<div class="tab-pane" id="profile">
										<table class="table table-striped shop_attributes">	
											<tbody>
												<tr class="">
													<th>Ingredients</th>
													<td>House Specialty, Pepperoni, Beef, Sauteed pork, Smoked Ham, Pineapple, Bell Pepper, Black Olives and Mozeralla Cheese</td>
												</tr>		
