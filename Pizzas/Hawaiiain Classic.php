    ...
    <body>		
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="../themes/images/pageBanner.jpg" alt="New products" >
				<h4><span>Hawaiiain Classic</span></h4>
			</section>
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="../themes/images/Pizza Photos/Hawaiiain Classic/Main.jpg" class="thumbnail" data-fancybox-group="group1" ><img alt="" src="../themes/images/Pizza Photos/Hawaiiain Classic/Main.jpg"></a>												
								<ul class="thumbnails small">								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Hawaiiain Classic/1.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Hawaiiain Classic/1.jpg" alt=""></a>
									</li>								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Hawaiiain Classic/2.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Hawaiiain Classic/2.jpg" alt=""></a>
									</li>													
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Hawaiiain Classic/3.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Hawaiiain Classic/3.jpg" alt=""></a>
									</li>
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Hawaiiain Classic/4.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Hawaiiain Classic/4.jpg" alt=""></a>
									</li>
								</ul>
							</div>
							<div class="span5">									
								<h4><strong>Price: ₱260.00</strong></h4>
							</div>
							<div class="span5">
						...
						<div class="row">
							<div class="span9">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="home">Classic Hawaiian Pizza combines pizza sauce, cooked ham, and pineapple. This crowd-pleasing pizza recipe starts with my homemade pizza. It’s salty, sweet, cheesy, and undeniably delicious!</div>
									<div class="tab-pane" id="profile">
										<table class="table table-striped shop_attributes">	
											<tbody>
												<tr class="">
													<th>Ingredients</th>
													<td>All time ingredients, with smoked ham, pineapple and mozarella cheese</td>
												</tr>		
												\
											</tbody>
										</table>
