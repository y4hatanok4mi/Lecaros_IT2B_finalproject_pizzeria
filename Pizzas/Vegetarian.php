			...
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="../themes/images/Pizza Photos/Vegetarian/Main.jpg" class="thumbnail" data-fancybox-group="group1" ><img alt="" src="../themes/images/Pizza Photos/Vegetarian/Main.jpg"></a>												
								<ul class="thumbnails small">								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Vegetarian/1.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Vegetarian/1.jpg" alt=""></a>
									</li>								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Vegetarian/2.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Vegetarian/2.jpg" alt=""></a>
									</li>													
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Vegetarian/3.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Vegetarian/3.jpg" alt=""></a>
									</li>
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Vegetarian/4.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Vegetarian/4.jpg" alt=""></a>
									</li>
								</ul>
							</div>
							<div class="span5">									
								<h4><strong>Price: ₱280.00</strong></h4>
							</div>
							<div class="span5">
						...
						<div class="row">
							<div class="span9">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="home">Vegetarian pizza features the same cheeses, seasonings, and sauces that regular pizza has, though the meat is replaced with vegetables and meat substitutes. Many people believe that a vegetarian pizza consists of only sauce and cheese, but vegetarian cooking can be anything but boring.</div>
									<div class="tab-pane" id="profile">
										<table class="table table-striped shop_attributes">	
											<tbody>
												<tr class="">
													<th>Ingredient</th>
													<td>Slice Tomato, Mushroom, Pineapple, White Onion, Bell </td>
												</tr>		
