    ...
    <body>		
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="../themes/images/pageBanner.jpg" alt="New products" >
				<h4><span>Beef and Mushroom</span></h4>
			</section>
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="../themes/images/Pizza Photos/Beef and Mushroom/Main.jpg" class="thumbnail" data-fancybox-group="group1" ><img alt="" src="../themes/images/Pizza Photos/Beef and Mushroom/Main.jpg"></a>												
								<ul class="thumbnails small">								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Beef and Mushroom/1.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Beef and Mushroom/1.jpg" alt=""></a>
									</li>								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Beef and Mushroom/2.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Beef and Mushroom/2.jpg" alt=""></a>
									</li>													
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Beef and Mushroom/3.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Beef and Mushroom/3.jpg" alt=""></a>
									</li>
									<li class="span1">
										<a href="../themes/images/Pizza Photos/Beef and Mushroom/4.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/Beef and Mushroom/4.jpg" alt=""></a>
									</li>
								</ul>
							</div>
							<div class="span5">									
								<h4><strong>Price: ₱309.00</strong></h4>
							</div>
							<div class="span5">
						...
						<div class="row">
							<div class="span9">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="home">Topped with braised beef slices with slices of mushroom, this NEW flavor will keep make you think how good you want your beef to be! They will delivers it to your doorstep, fresh and hot.</div>
									<div class="tab-pane" id="profile">
										<table class="table table-striped shop_attributes">	
											<tbody>
												<tr class="">
													<th>Ingredients</th>
													<td>Sauteed Beef, Mozarella Cheese</td>
												</tr>		
