			...
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="../themes/images/Pizza Photos/All Cheese/Main.jpg" class="thumbnail" data-fancybox-group="group1" ><img alt="" src="../themes/images/Pizza Photos/All Cheese/Main.jpg"></a>												
								<ul class="thumbnails small">								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/All Cheese/1.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/All Cheese/1.jpg" alt=""></a>
									</li>								
									<li class="span1">
										<a href="../themes/images/Pizza Photos/All Cheese/2.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/All Cheese/2.jpg" alt=""></a>
									</li>													
									<li class="span1">
										<a href="../themes/images/Pizza Photos/All Cheese/3.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/All Cheese/3.jpg" alt=""></a>
									</li>
									<li class="span1">
										<a href="../themes/images/Pizza Photos/All Cheese/4.jpg" class="thumbnail" data-fancybox-group="group1"><img src="../themes/images/Pizza Photos/All Cheese/4.jpg" alt=""></a>
									</li>
								</ul>
							</div>
							<div class="span5">									
						...
						<div class="row">
							<div class="span9">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="home">Pizza cheese is "a soft spun-curd cheese similar to Mozzarella made from cow's milk..." that is "...used particularly for pizzas and contains somewhat less water than real Mozzarella..." Most are at least 95 percent Mozzarella, with different moisture and fat </div>
									<div class="tab-pane" id="profile">
										<table class="table table-striped shop_attributes">	
											<tbody>
												<tr class="">
													<th>Ingredients</th>
													<td>Pizza Cheese, Mozarella and Parmesan</td>
